...
**** GLM for Racket is (going to be) Damn Fast
...
Computer Graphics: vector multiplication, four 32-bit elements per vector

Data Science: vector multiplication, one thousand 64-bit elements per vector
